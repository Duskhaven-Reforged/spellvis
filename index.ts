...
async function spellVisualEdit(spellId: any, newSpellId: any, effectName: any) {
...
async function spellVisualEffectEdit(
  spellId: any,
  newSpellId: any,
  effectName: any
) {
...
async function spellVisualKitEdit(spellId: any, newSpellId: any) {
...
function appendCSV(csvString: string, spellId: number, fileName: string) {
